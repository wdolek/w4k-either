...
internal sealed class MatchGenerator : IMemberCodeGenerator
{
    ...
    private void WriteMatch(IndentedWriter writer)
    {
        ...
        writer.AppendIndentedLine("            return global::Either.ThrowHelper.ThrowOnInvalidState<TResult>();");
        writer.AppendIndentedLine("    }");
        writer.AppendIndentedLine("}");
        writer.AppendLineBreak();
    }
    ...
    private void WriteAsyncMatch(IndentedWriter writer)
    {
        ...
        writer.AppendIndentedLine("        default:");
        writer.AppendIndentedLine("            return global::Either.ThrowHelper.ThrowOnInvalidState<global::System.Threading.Tasks.Task<TResult>>();");
        writer.AppendIndentedLine("    }");
        writer.AppendIndentedLine("}");
        writer.AppendLineBreak();
    }
